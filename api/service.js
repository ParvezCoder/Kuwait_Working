...
import sImg2 from '/public/images/services/service_image_9.webp'
...
const Services = [
    {
        ...
        slug2: 10,
        thumb1:'SOP-Services',
        thumb2:'Business-Consulting',
        thumb3:'Data Management',
        col:'col-lg-6',
    ...
    },
    {
        ...
        slug1: 13,
        slug2: 14,
        thumb1:'Data Warehousing',
        thumb2:'Data Migration',
        col:'col-lg-6',
    ...
    },
    {
        Id: '4',
        sImg:sImg4,
        title: 'IT Support and Integration',
        slug: 17,
        slug1: 18,
        slug2: 15,
        thumb1:'IT-Solutions',
    ...
    // },
        ...
        //     features: ['Professional translation', 'Certified translators', 'Multilingual support', 'Industry-specific translation']
        // },
        // {
        //     Id: '7',
        //     sImg: icon2,
        ...
        //     features: ['Audio-to-text conversion', 'Legal transcription', 'Medical transcription', 'Interview transcription']
        // },
        {
            Id: '6',
            sImg: icon5,
            title: 'ERP',
            slug: 'ERP-Services',
            Link:"/DigitalEdgeKuwaitServicesDetails",
            features: ['Enterprise resource planning', 'Business process management', 'Supply chain management', 'Financial management']
        },
        {
            Id: '7',
            sImg: icon9,
            title: 'CRM',
            slug: 'Marketing-Services-2',
            features: ['contact management', 'sales automation', 'email marketing', 'analytics'],
            Link:"/DigitalEdgeKuwaitServicesDetails"
        },
        {
            Id: '8',
            sImg: icon4,
            title: 'Recruiterment Services',
            slug: 'Recruiterment-Services',
            features: ['Talent acquisition', 'Staffing solutions', 'HR consulting', 'Employee training and development'],
            Link:"/DigitalEdgeKuwaitServicesDetails"
        },
        {
            Id: '9',
            sImg: icon6,
            title: 'IT Turnkey Solutions',
            slug: 'IT-Turnkey-Solutions',
            features: ['Custom software development', 'System integration', 'IT infrastructure management', 'Cloud solutions'],
            Link:"/services/TurnkeySolutions"
        },
        
        {
            ...
            slug: 'Design-and-Development-Services',
            features: ['UI/UX design', 'Web development', 'Software development', 'Custom programming'],
        ...
        },
        {
            ...
            features: ['Digital marketing', 'Brand management', 'Market research', 'Advertising strategy'],
            Link:"/DigitalEdgeKuwaitServicesDetails"
        }
