...
import discoveryImg from '/public/images/lifecycle/technical2.jpg';
import designDevImg from '/public/images/lifecycle/customization.jpg';
import testingQaImg from '/public/images/lifecycle/value.jpg';
import deploymentImg from '/public/images/lifecycle/partnership.jpg';
import discoverIcon from '/public/images/icons/icon_enterprise.svg';
import designIcon from '/public/images/icons/icon_design.svg';
import developIcon from '/public/images/icons/icon_development.svg';
import testIcon from '/public/images/icons/icon_test.svg';
import deployIcon from '/public/images/icons/icon_deploy.svg';
import maintainIcon from '/public/images/icons/icon_maintain.svg';
    ...
    return (
      <Fragment>
        <Head>
          ...
          <meta
            name="description"
            content="ODOO Business in Kuwait, ODOO Business Kuwait, Certified ODOO Partner Kuwait, ODOO Implementation Kuwait, ODOO ERP Kuwait, Best ODOO Partner in Kuwait, ODOO Consulting Kuwait, شريك أودو في الكويت, وكلاء أودو الكويت, شريك أودو الذهبي الكويت, أفضل شركاء أودو في الكويت, حلول أودو للشركات الكويتية, تطبيق أودو الكويت, استشارات أودو الكويت, Partner with Corp-Digital for comprehensive Odoo ERP solutions with technical expertise, customization services, and long-term support."
          />
          <meta
            name="keywords"
          ...
          <meta
            property="og:url"
            content="https://corp.digital53.com/odoo-partnership"
          />
          <meta
            property="og:image"
          ...
          <link
            rel="canonical"
            href="https://corp.digital53.com/odoo-partnership"
          />
        </Head>
        <Header />
        <main style={{ backgroundColor: "#ffffff", overflowX: "hidden" }}>
          <PageTitle
            pageTitle={"Odoo Partnership"}
            ...
            <div className="container">
              <div style={headingBlockStyle}>
                ...
                <p style={headingDescriptionStyle}>
                  Customized Odoo with Corp-Digital for comprehensive enterprise
                  resource planning (ERP) solutions backed by extensive
                  technical expertise and long-term commitment to your
                  success.ODOO Expertise in Kuwait, ODOO Customization Kuwait,
                  Certified ODOO Development Language developers Kuwait,ODOO
                  Implementation Kuwait, ODOO ERP Kuwait, Best ODOO Expertise in
                  Kuwait, ODOO Consulting Kuwait, شريك أودو في الكويت, ودو
                  الكويت, أودو الكويت,أفضل شركاء أودو في الكويت, حلول أودو
                  للشركات الكويتية, تطبيق أودو الكويت, استشارات أودو الكويت,
                  Partner with Digital Edge for comprehensive Odoo ERP solutions
                  with technical expertise, customization services, and
                  long-term support{" "}
                </p>
              </div>
                ...
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <p style={cardDescriptionStyle}>
                      Our comprehensive technical expertise ensures seamless
                      Odoo implementation with advanced customizations tailored
                    ...
                    <ul style={{ paddingLeft: "0" }}>
                      ...
                      <li style={listItemStyle}>
                        ...
                        <span style={responsiveListTextStyle}>
                          ...
                          customizations, custom modules, and workflow
                          automation
                        </span>
                      </li>
                      <li style={listItemStyle}>
                        ...
                        <span style={responsiveListTextStyle}>
                          <strong>Database Migration:</strong> Safe data
                          migration from legacy systems with minimal downtime
                        </span>
                      </li>
                      <li style={listItemStyle}>
                        <span style={listIconStyle}>
                    ...
                    <ul style={{ paddingLeft: "0" }}>
                      ...
                      <li style={bestPracticeStyle}>
                        ...
                        Mobile Solutions and Cloud & On-Premise Deployment
                        options
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul style={{ paddingLeft: "0" }}>
                      <li style={listItemStyle}>
                        ...
                        <span style={listTextDarkStyle}>
                          <strong>Workflow Analysis:</strong> Comprehensive
                      ...
                      <div>
                        ...
                        <p
                          style={{
                            ...
                            fontSize:
                              viewportWidth < 576 ? "0.85rem" : "0.95rem",
                          }}
                        >
                          {phase.description}
                        </p>
                  ...
                  >
                    ...
                    <ul style={{ paddingLeft: "0" }}>
                      <li style={bestPracticeStyle}>
                        ...
                        Improved operational efficiency through process
                        automation
                      </li>
                      <li style={bestPracticeStyle}>
                        <span style={checkIconStyle}>
                    ...
                    <ul style={{ paddingLeft: "0" }}>
                      <li style={bestPracticeStyle}>
                        ...
                        Long-term relationship focus beyond initial
                        implementation
                      </li>
                      <li style={bestPracticeStyle}>
                        <span style={checkIconStyle}>
          ...
          {/* Long-term Partnership Framework Section */}
          <section style={darkSectionStyle}>
            <div className="container">
              <div className="row align-items-center flex-row-reverse">
                <div className="col-lg-6">
          ...
          <section style={sectionStyle}>
            <div className="container">
              <div style={headingBlockStyle}>
                <div style={responsiveHeadingFocusTextStyle}>
                  Partnership <span style={responsiveBadgeStyle}>Success</span>
                </div>
                <h2
                  style={{
                    ...responsiveHeadingTextStyle,
                ...
                <p style={headingDescriptionStyle}>
                  Our partnerships with client deliver tangible business
                  outcomes and measurable improvements across key performance
                  indicators.
                </p>
              </div>
              <div className="row">
