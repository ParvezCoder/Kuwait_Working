                                ...
                                <div className="col-md-6" key={fitem}>
                                    <div className="funfact_block">
                                        <div className="funfact_icon">
                                            <Image src={funfact.icon} alt="Corp-Digital - SVG Icon Head" />
                                        </div>
                    ...
                    <div className="col-lg-4">
                        <div className="our_world_employees">
                            <div className="image_wrap">
                                <Image src={fimg} alt="Corp-Digital - Employees Guoup" />
                            </div>
                            <div className="content_wrap">
                                <h3 className="title_text mb-0">
                                    <b className="d-block">Skilled</b> employees from all over the world.
                                </h3>
                            </div>
                        </div>
                    </div>
