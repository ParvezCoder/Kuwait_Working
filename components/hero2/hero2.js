                ...
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        <div className="content_wrap">
                            ...
                            <ul className="btns_group unordered_list p-0 justify-content-start">
                                ...
                                <li>
                                <a className="hotline_block" href="tel:+96599144152">
                                        <span className="hotline_icon">
                                            <i className="fa-solid fa-phone-volume"></i>
                                        </span>
                                        <span className="hotline_content">
                                            <small>CONTACT US DAILY</small>
                                            <strong className="text-white">+96599144152</strong>
                                        </span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div className="engine_image">
                        <div className="image_wrap_1">
                            <Image src={circle1} alt="Engine" width={500} priority />
                        </div>
                        <div className="image_wrap_2">
                            <Image src={circle2} alt="Engine" width={500} priority />
                        </div>
                        <div className="image_wrap_3">
                            <Image src={circle3} alt="Engine" width={500} priority />
                        </div>
                        <div className="image_wrap_4">
                            <Image src={circle4} alt="Engine" width={500} priority />
                        </div>
                    </div>

                    <div className="shape_image_1">
                        <Image src={shape1} alt="Engine" width={1000} priority />
                    </div>
                    <div className="shape_image_2">
                        <Image src={shape2} alt="Engine" width={1000} priority />
                    </div>
                    <div className="shape_image_3">
                        <Image src={shape3} alt="Engine" width={1000} priority />
                    </div>
                    <div className="shape_image_4">
                        <Image src={shape4} alt="Engine" width={1000} priority />
                    </div>
                    </div>
                </div>
            </div>
