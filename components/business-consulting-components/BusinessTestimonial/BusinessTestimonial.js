...
const testimonial = [
    {
        id: '01',
        Des: "Working with Corp-Digital was a game-changer for our business. Their  tailored solutions and dedicated support propelled us to new heights",
        Title: 'Sarah Johnson',
                ...
                <div className="container">
                    <div className="row align-items-center justify-content-lg-around">
                        <div className="col-lg-6">
                            ...
                            <Link onClick={ClickHandler} className="creative_btn" href="/pricing">
                            ...
                            <div className="about_image_3">
                                ...
                                <div className="funfact_block capsule_layout">
                                    <div className="funfact_icon">
                                        <Image src={abImg2} alt="Corp-Digital - SVG Icon Wallet" />
                                    </div>
