            ...
            <div className="col-lg-4">
                <div className="deals_winner_customers">
                    <h3 className="title_text">
                        <mark>3,900+</mark> customers win deals with Corp-Digital
                    </h3>
                    {/* <div className="row">
                        <div className="col-6">
                        ...
                        {/* <div className="carousel_arrows_nav">
                            ...
                            <button ref={nextRef} type="button" className="r1cc-swiper-button-next">
                                <i className="fa-solid fa-arrow-right"></i>
                                    ...
                                    <div className="review_block_2">
                                        <h3 className="review_title">“Digital Edge Solutions”</h3>
                                        <p className="review_commtent">
                                        Digital Edge Solutions has pioneered the way in solving client’s real world of Information Technologies With a quality of services and sound modern technology. We have above 30 years of the Experience in ERP Solutions therefore every eCommerce, Web, Mobile Application we make have our expertise that pays back to our valued customers.
                                        </p>
                                    </div>
                    </div>
                </div>
