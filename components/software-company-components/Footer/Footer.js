...
const expertiseItems = [
  { name: 'DE ERP', link: 'http://erp53.com' },
  { name: 'POS System TMBill', link: '/POSTMBill' },
  { name: 'Driver APP', link: 'https://catering.erp53.com/' },
  { name: 'DE Ecommerce', link: 'http://bestbuy53.com' },
  { name: 'DE Recruitment', link: 'http://hrm53.com' },
  { name: 'DE POS', link: 'http://pos53.com' },
  { name: 'DigitalMenu', link: '#' }
];
  ...
  return (
    ...
    >
      <div className="decoration_item shape_image_1">
        <Image src={icon1} alt="Corp-Digital Shape" />
      </div>
          ...
          <div className="row justify-content-lg-between">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="footer_widget pe-lg-3">
                <h2 className="footer_info_title">Want Updates?</h2>
                <p>Subscribe us and receive mails about our latest products.</p>
                ...
                <ul className="social_icons_block unordered_list">
                  ...
                  <li>
                    <Link
                      onClick={ClickHandler}
                      href="https://www.instagram.com/digitaledge.q8/"
                      target="_blank"
                    >
      ...
      >
        <div className="container d-md-flex align-items-md-center justify-content-md-between">
          <p className="copyright_text m-0">
            Copyright © {new Date().getFullYear()} Corp-Digital, All rights
            reserved.{" "}
          </p>
          <ul className="icon_list unordered_list">
            ...
            <li>
              <Link onClick={ClickHandler} href="/contact">
                ...
                <span className="icon_list_text">API Documentation</span>
              </Link>
            </li>
          </ul>
        </div>
